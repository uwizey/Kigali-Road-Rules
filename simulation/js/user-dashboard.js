...
const _MOCK_TOPICS = [
  {
    ...
    name: "Traffic Signs",
    subtopics: [
      { id: "101", name: "Warning Signs" },
      { id: "102", name: "Regulatory Signs" },
      { id: "103", name: "Informational Signs" },
    ],
  },
  {
    id: "2",
    name: "Road Rules",
    subtopics: [
      { id: "201", name: "Speed Limits" },
      { id: "202", name: "Right of Way" },
      { id: "203", name: "Parking Rules" },
    ],
  },
  {
    id: "3",
    name: "Vehicle Safety",
    subtopics: [
      { id: "301", name: "Seatbelts & Restraints" },
      { id: "302", name: "Lights & Signals" },
    ],
  },
];

// Components keyed by subtopic id — demonstrates every format_type your renderer supports
const _MOCK_SECTIONS = {
  "101": [{ section_id: "s101a", order_index: 0 }],
  "102": [{ section_id: "s102a", order_index: 0 }],
  "103": [{ section_id: "s103a", order_index: 0 }],
  "201": [{ section_id: "s201a", order_index: 0 }],
  "202": [{ section_id: "s202a", order_index: 0 }],
  "203": [{ section_id: "s203a", order_index: 0 }],
  "301": [{ section_id: "s301a", order_index: 0 }],
  "302": [{ section_id: "s302a", order_index: 0 }],
};

const _MOCK_COMPONENTS = {
  s101a: [
    {
      component_id: 1, format_type: "accordion", title: "Types of Warning Signs",
      order_index: 0,
      items: [
        { order_index: 0, title: "Curve Ahead", content: "A curved arrow sign warns drivers of an upcoming bend. Reduce speed and stay in your lane." },
        { order_index: 1, title: "Slippery Road", content: "Indicates the road surface may be slippery, especially in wet conditions. Avoid sudden braking." },
        { order_index: 2, title: "Pedestrian Crossing", content: "Alerts drivers that pedestrians may be crossing the road. Be prepared to yield." },
      ],
    },
  ],
  s102a: [
    {
      component_id: 2, format_type: "tabs", title: "Regulatory Sign Categories",
      order_index: 0,
      items: [
        { order_index: 0, title: "Speed Limits", content: "Speed limit signs show the maximum legal speed on that road. Exceeding them carries fines and endangers lives.", image: null },
        { order_index: 1, title: "No Entry",     content: "A red circle with a white bar means no vehicles may enter that road. Entering is a serious traffic offence.", image: null },
        { order_index: 2, title: "Give Way",     content: "The inverted triangle tells you to yield to traffic on the main road before proceeding.", image: null },
      ],
    },
  ],
  s103a: [
    {
      component_id: 3, format_type: "flipcards", title: "Common Informational Signs",
      order_index: 0,
      items: [
        { order_index: 0, title: "Hospital", description: "Indicates a hospital is nearby. Keep noise levels low and drive carefully.", image: null },
        { order_index: 1, title: "Fuel Station", description: "A fuel pump symbol shows the nearest fuel station. Plan refuelling stops on long journeys.", image: null },
        { order_index: 2, title: "Parking Area", description: "A blue 'P' marks a designated parking zone. Always check time restrictions.", image: null },
      ],
    },
  ],
  s201a: [
    {
      component_id: 4, format_type: "timeline", title: "Understanding Speed Limits",
      order_index: 0,
      items: [
        { order_index: 0, title: "Urban Areas — 50 km/h", description: "The default speed limit inside towns and cities in Rwanda." },
        { order_index: 1, title: "School Zones — 30 km/h", description: "Reduced limit applies during school hours. Strictly enforced." },
        { order_index: 2, title: "Highways — 80 km/h", description: "Inter-city roads permit higher speeds but require greater following distances." },
        { order_index: 3, title: "Expressways — 100 km/h", description: "Rwanda's expressways allow 100 km/h for vehicles in good mechanical condition." },
      ],
    },
  ],
  s202a: [
    {
      component_id: 5, format_type: "image_right", title: "Right of Way at Intersections",
      order_index: 0,
      items: [
        {
          order_index: 0,
          title: "Right of Way at Intersections",
          content: "At an uncontrolled intersection, give way to traffic coming from your right. At a four-way stop, the first vehicle to arrive has the right of way. When in doubt, yield — it prevents accidents.",
          image: null,
        },
      ],
    },
  ...
  s203a: [
    {
      component_id: 6, format_type: "accordion", title: "Parking Rules",
      order_index: 0,
      items: [
        { order_index: 0, title: "No Parking Zones", content: "Never park within 5 m of a fire hydrant, 10 m of an intersection, or on a pedestrian crossing." },
        { order_index: 1, title: "Parking on Hills", content: "When parking uphill with a kerb, turn wheels away from the kerb. Downhill — turn toward the kerb. Always apply the handbrake." },
        { order_index: 2, title: "Disability Bays", content: "Parking in a disability bay without a valid permit carries heavy fines and possible vehicle clamping." },
      ],
    },
  ],
  s301a: [
    {
      component_id: 7, format_type: "tabs", title: "Seatbelt & Child Restraints",
      order_index: 0,
      items: [
        { order_index: 0, title: "Driver & Front Passenger", content: "Both must wear seatbelts at all times. The driver is legally responsible for ensuring all passengers under 14 are restrained.", image: null },
        { order_index: 1, title: "Child Seats",              content: "Children under 12 or below 135 cm must use an approved child restraint appropriate for their weight group.", image: null },
        { order_index: 2, title: "Rear Passengers",          content: "All rear passengers must also wear seatbelts where fitted. No exceptions.", image: null },
      ],
    },
  ],
  s302a: [
    {
      component_id: 8, format_type: "timeline", title: "When to Use Your Lights",
      order_index: 0,
      items: [
        { order_index: 0, title: "Dipped Headlights",  description: "Use from dusk to dawn and in poor visibility such as rain or fog." },
        { order_index: 1, title: "Full Beam",          description: "Only on unlit roads with no oncoming traffic. Switch off or dip when within 200 m of another vehicle." },
        { order_index: 2, title: "Hazard Lights",      description: "Use when stationary and causing a temporary obstruction, or in an emergency. Never as an excuse to park illegally." },
        { order_index: 3, title: "Indicators",         description: "Always signal before turning or changing lanes. Signal early enough to give other road users time to react." },
      ],
    },
  ],
};

// Exercise questions keyed by subtopic name (lowercase)
const _MOCK_EXERCISES = {
  "warning signs": [
    { statement: "A yellow diamond-shaped sign typically indicates:", options: { A: { id: 1, text: "A speed limit" }, B: { id: 2, text: "A hazard or warning ahead" }, C: { id: 3, text: "A mandatory instruction" }, D: { id: 4, text: "A parking area" } }, correctAnswerId: 2 },
    { statement: "What should you do when you see a 'Slippery Road' sign?", options: { A: { id: 5, text: "Speed up to pass the zone quickly" }, B: { id: 6, text: "Reduce speed and avoid sudden braking" }, C: { id: 7, text: "Switch on full-beam headlights" }, D: { id: 8, text: "Move to the centre of the road" } }, correctAnswerId: 6 },
  ],
  "speed limits": [
    { statement: "What is the default speed limit inside Rwandan towns?", options: { A: { id: 9, text: "30 km/h" }, B: { id: 10, text: "40 km/h" }, C: { id: 11, text: "50 km/h" }, D: { id: 12, text: "60 km/h" } }, correctAnswerId: 11 },
    { statement: "What speed limit applies in a school zone during school hours?", options: { A: { id: 13, text: "50 km/h" }, B: { id: 14, text: "40 km/h" }, C: { id: 15, text: "30 km/h" }, D: { id: 16, text: "20 km/h" } }, correctAnswerId: 15 },
  ],
};

// Backend-style quiz sessions for the Police Exam screen
const _MOCK_QUIZ_SESSIONS = [
  {
    quiz_id: "session-mar-2025",
    title: "March 2025 Police Exam",
    publish_date: "2025-03-10T08:00:00Z",
    question_count: 5,
    questions: [201, 202, 203, 204, 205],
  },
  {
    quiz_id: "session-jan-2025",
    title: "January 2025 Police Exam",
...
// Individual questions fetched by id (used by /question/:id and /quiz/:id flows)
const _MOCK_QUESTIONS = {
  201: { question_id: 201, statement: "What is the maximum legal BAC (blood alcohol content) for drivers in Rwanda?", options: { A: { id: 801, text: "0.08%" }, B: { id: 802, text: "0.05%" }, C: { id: 803, text: "0.00%" }, D: { id: 804, text: "0.10%" } }, correctAnswerId: 803, topic: "Road Rules" },
  202: { question_id: 202, statement: "When must you dip your headlights for oncoming traffic?", options: { A: { id: 805, text: "Never" }, B: { id: 806, text: "Only on highways" }, C: { id: 807, text: "Within 200 m of an oncoming vehicle" }, D: { id: 808, text: "Only in the city" } }, correctAnswerId: 807, topic: "Vehicle Safety" },
  203: { question_id: 203, statement: "Overtaking on a solid white centre line is:", options: { A: { id: 809, text: "Allowed if the road is clear" }, B: { id: 810, text: "Allowed at slow speeds" }, C: { id: 811, text: "Never allowed" }, D: { id: 812, text: "Allowed for motorcycles only" } }, correctAnswerId: 811, topic: "Road Rules" },
  204: { question_id: 204, statement: "Which side of the road do vehicles drive on in Rwanda?", options: { A: { id: 813, text: "Left" }, B: { id: 814, text: "Right" }, C: { id: 815, text: "Either side" }, D: { id: 816, text: "Centre" } }, correctAnswerId: 814, topic: "Road Rules" },
  205: { question_id: 205, statement: "A pedestrian crossing is marked by:", options: { A: { id: 817, text: "Red lines" }, B: { id: 818, text: "Yellow dashes" }, C: { id: 819, text: "White stripes" }, D: { id: 820, text: "Blue arrows" } }, correctAnswerId: 819, topic: "Traffic Signs" },
  206: { question_id: 206, statement: "Under what condition may a driver legally use a mobile phone?", options: { A: { id: 821, text: "With one hand on the wheel" }, B: { id: 822, text: "When stationary at lights" }, C: { id: 823, text: "Only with a hands-free device" }, D: { id: 824, text: "Never" } }, correctAnswerId: 823, topic: "Road Rules" },
  207: { question_id: 207, statement: "Headlights must be used:", options: { A: { id: 825, text: "Only in complete darkness" }, B: { id: 826, text: "From dusk to dawn and in low visibility" }, C: { id: 827, text: "Only on highways at night" }, D: { id: 828, text: "Whenever the driver feels like it" } }, correctAnswerId: 826, topic: "Vehicle Safety" },
  208: { question_id: 208, statement: "At a four-way stop, who has the right of way?", options: { A: { id: 829, text: "The largest vehicle" }, B: { id: 830, text: "The first to arrive" }, C: { id: 831, text: "The fastest driver" }, D: { id: 832, text: "Always the vehicle on the left" } }, correctAnswerId: 830, topic: "Road Rules" },
  209: { question_id: 209, statement: "What shape is an international STOP sign?", options: { A: { id: 833, text: "Triangle" }, B: { id: 834, text: "Circle" }, C: { id: 835, text: "Octagon" }, D: { id: 836, text: "Square" } }, correctAnswerId: 835, topic: "Traffic Signs" },
  210: { question_id: 210, statement: "You should check your mirrors every:", options: { A: { id: 837, text: "5–8 seconds" }, B: { id: 838, text: "30 seconds" }, C: { id: 839, text: "Only when turning" }, D: { id: 840, text: "Only when changing lanes" } }, correctAnswerId: 837, topic: "Road Rules" },
};

// Overview quiz — random mix (question ids)
const _MOCK_OVERVIEW_QUESTION_IDS = [201, 203, 205, 207, 209];
...
function _err(message, status = 400) {
  return { success: false, status, error: { message }, userMessage: message };
}

// ── FetchData simulation ──────────────────────────────────────────────────────

async function FetchData(endpoint, _requiresAuth = false) {
  await _delay();

  // /logout
  if (endpoint === "/logout") return _ok({});
  ...
  if (endpoint === "/user/profile") {
    ...
    try {
      ...
      return _ok({ data: { email: payload.email || "demo@krr.rw" } });
    } catch {
      return _ok({ data: { email: "demo@krr.rw" } });
    }
  }

  // /topic — returns all topics with their subtopics
  if (endpoint === "/topic") {
    return _ok({ topics: _MOCK_TOPICS });
  }

  // /sections/:subtopicId
  const sectionsMatch = endpoint.match(/^\/sections\/([^/]+)$/);
  if (sectionsMatch) {
    const id = sectionsMatch[1];
    const sections = _MOCK_SECTIONS[id];
    if (!sections) return _ok({ sections: [] });
    return _ok({ sections });
  }

  // /sections/:sectionId/components
  const componentsMatch = endpoint.match(/^\/sections\/([^/]+)\/components$/);
  if (componentsMatch) {
    const sectionId = componentsMatch[1];
    const components = _MOCK_COMPONENTS[sectionId];
    if (!components) return _ok({ components: [] });
    return _ok({ components });
  }

  // /exercise?topic=<subtopicName>
  if (endpoint.startsWith("/exercise")) {
    const params = new URLSearchParams(endpoint.split("?")[1] ?? "");
    const topic = (params.get("topic") ?? "").toLowerCase();
    const ids = Object.keys(_MOCK_EXERCISES).find((k) => topic.includes(k));
    if (!ids) return _ok({ questions: [] });
    // Return fake question IDs so the caller can fetch them individually
    return _ok({ questions: [ids + "_0", ids + "_1"] });
  }

  // /question/:id  — used by exercise loader (ids are "<topicKey>_<index>")
  const exerciseQMatch = endpoint.match(/^\/question\/(.+)_(\d+)$/);
  if (exerciseQMatch) {
    const topicKey = exerciseQMatch[1];
    const index = parseInt(exerciseQMatch[2]);
    const qs = _MOCK_EXERCISES[topicKey];
    if (!qs || !qs[index]) return _err("Question not found", 404);
    return _ok({ question: qs[index] });
  }

  // /quiz/random — overview (no params) or topic-specific
  if (endpoint.startsWith("/quiz/random")) {
    const params = new URLSearchParams(endpoint.split("?")[1] ?? "");
    const topic = (params.get("topic") ?? "").toLowerCase();

    if (!topic) {
      // Overview quiz
      return _ok({ questions: _MOCK_OVERVIEW_QUESTION_IDS });
    }

    // Topic quiz — find matching questions
    const matchingIds = Object.entries(_MOCK_QUESTIONS)
      .filter(([, q]) => q.topic.toLowerCase().includes(topic) || topic.includes(q.topic.toLowerCase()))
      .map(([id]) => parseInt(id));

    if (!matchingIds.length) return _ok({ questions: [] });
    return _ok({ questions: matchingIds.slice(0, 5) });
  }

  // /quizzes — backend exam sessions list
  if (endpoint === "/quizzes") {
    return _ok({ quizzes: _MOCK_QUIZ_SESSIONS });
  }

  // /quiz/:sessionId — fetch a specific exam session's question ids
  const quizSessionMatch = endpoint.match(/^\/quiz\/(.+)$/);
  if (quizSessionMatch) {
    const sessionId = quizSessionMatch[1];
    const session = _MOCK_QUIZ_SESSIONS.find((s) => s.quiz_id === sessionId);
    if (!session) return _err("Quiz not found", 404);
    return _ok({ questions: session.questions });
  }

  // /question/:numericId — used by quiz loaders
  const questionMatch = endpoint.match(/^\/question\/(\d+)$/);
  if (questionMatch) {
    const id = parseInt(questionMatch[1]);
    const q = _MOCK_QUESTIONS[id];
    if (!q) return _err("Question not found", 404);
    return _ok({ question: q });
  }

  return _err(`Unknown endpoint: ${endpoint}`, 404);
}

// Stubs — PostData / DeleteData / UpdateData are not called in this file
// but kept so nothing breaks if they get referenced.
