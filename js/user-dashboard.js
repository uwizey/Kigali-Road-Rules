...
function switchMode(mode) {
    ...
    document.getElementById('dashTitle').textContent = `Dashboard - ${mode === 'content' ? 'Content' : 'Q&A'} Mode`;
    
    // Toggle sidebar content
    document.getElementById('contentSidebar').classList.toggle('active', mode === 'content');
    document.getElementById('qaSidebar').classList.toggle('active', mode === 'qa');
    
    // Toggle main content views
    document.getElementById('contentModeView').classList.toggle('active', mode === 'content');
    document.getElementById('qaModeView').classList.toggle('active', mode === 'qa');
...
function loadContent(event, topic, subtopic) {
    ...
    if (content) {
        ...
        document.getElementById('contentTitle').textContent = `${topic} - ${subtopic}`;
        const textFormat = document.getElementById('textFormat');
        textFormat.style.display = 'block';
...
function loadQuestion() {
    ...
    if (userAnswers[currentQuestionIndex]) {
        document.getElementById(`answer${userAnswers[currentQuestionIndex]}`).checked = true;
...
function calculateAndShowResults() {
    ...
    document.getElementById('scoreRatio').textContent = `${correctCount}/${totalQuestions}`;
    ...
    console.log(`Quiz completed: ${correctCount}/${totalQuestions} (${scorePercentage}%)`);
}
